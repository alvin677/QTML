...
It also tries to make websites more mobile adapted.<br/>
*This "framework" is far from good and finished, it is just something that I use wrote to use personally.*
